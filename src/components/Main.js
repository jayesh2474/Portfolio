...
const Main = () => {
    ...
    useEffect(() => {
        ...
        if (hasVisited) {
            setClick(true); // Set click to true if the user has already visited
        }
    }, []);

    const handleClick = () => {
        setClick(true); // Set click to true on first interaction
    ...
    return (
        <MainContainer>
            ...
            <Container>
                ...
                <Contact target="_blank" href="mailto:divyeshjoshi7474@gmail.com">
                    <motion.h2
